...
public class Rectanglef {
     ...
     */
    public boolean edgeOverlaps(Rectanglef r) {
     ...
     * does not
     */
    public boolean containedBy(Rectanglef r) {
     ...
     */
    public float distance(PointFloat p) {
     ...
     * @return enlargement
     */
    public float enlargement(Rectanglef r) {
    ...
    public PointFloat centre() {
        return new PointFloat((minX + maxX) / 2, (minY + maxY) / 2);
    }
