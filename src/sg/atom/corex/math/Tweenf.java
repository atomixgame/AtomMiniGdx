...
public class Tweenf {
    ...
    public static class ElasticOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            return a * (float) Math.pow(2, -10 * t) * (float) FastMath.sin((t * d - s) * (2 * FastMath.PI) / p) + c + b;
        }
    }
    /**
    ...
    public static class ElasticInOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t < 1) {
                return -.5f * (a * (float) Math.pow(2, 10 * (t -= 1)) * (float) FastMath.sin((t * d - s) * (2 * FastMath.PI) / p)) + b;
            }
            return a * (float) Math.pow(2, -10 * (t -= 1)) * (float) FastMath.sin((t * d - s) * (2 * FastMath.PI) / p) * .5f + c + b;
        }
    }
    ...
    public static final Easing BOUNCE_IN_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            if (t < d / 2) {
                return BOUNCE_IN.ease(t * 2, 0, c, d) * .5f + b;
            }
