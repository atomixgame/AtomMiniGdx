...
public class TiledLoader3D extends AbstractAppState {
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        this.layerConverters = new LinkedHashMap<String, TileLayerConverter>();
    }
    ...
    public MapStructure loadMap(String mapFileName) {
...
//        logger.info("Loaded map "+ map.getWidth() + " x " + map.getHeight());
    ...
    public TiledMap3D loadMap3D(String mapFileName) {
        ...
        map3D.setLayerConverters(layerConverters);
    ...
    public void addLayerConverter(String regex, TileLayerConverter layerConverter) {
        layerConverters.put(regex, layerConverter);
    }
}
