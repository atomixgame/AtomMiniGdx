...
public class ObjectMap<K, V> {
    ...
    public ObjectMap(int initialCapacity, float loadFactor) {
        ...
        capacity = FastMath.nearestPowerOfTwo(initialCapacity);
    ...
    private void push(K insertKey, V insertValue, int index1, K key1, int index2, K key2, int index3, K key3) {
        ...
        do {
            ...
            switch (FastMath.nextRandomInt(0, 2)) {
                case 0:
                    evictedKey = key1;
    ...
    public void shrink(int maximumCapacity) {
        ...
        maximumCapacity = FastMath.nearestPowerOfTwo(maximumCapacity);
    ...
    public void ensureCapacity(int additionalCapacity) {
        ...
        if (sizeNeeded >= threshold) {
            resize(FastMath.nearestPowerOfTwo((int) (sizeNeeded / loadFactor)));
        }
    }
    ...
    static protected class MapIterator<K, V> {
