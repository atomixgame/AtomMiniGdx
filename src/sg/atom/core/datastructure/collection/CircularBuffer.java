...
public class CircularBuffer<T> {
    ...
    /**
     * Creates a resizable {@code CircularBuffer} with the given initial
     * capacity.
     *
    ...
    /**
     * Returns {@code true} if this circular buffer is empty; {@code false}
     * otherwise.
     */
    ...
    /**
     * Returns {@code true} if this circular buffer contains as many items as
     * its capacity; {@code false} otherwise.
     */
    ...
    /**
     * Returns {@code true} if this circular buffer can be resized;
    ...
    /**
     * Sets the flag specifying whether this circular buffer can be resized or
     * not.
     *
