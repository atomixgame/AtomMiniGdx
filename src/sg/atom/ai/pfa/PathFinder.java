...
import sg.atom.core.datastructure.graph.Connection;
...
public interface PathFinder<N> {
     ...
     * connections from the start node to the goal node attempting to honor
     * costs provided by the graph.
     *
     * @param startNode the start node
     * @param endNode the end node
     * @param heuristic the heuristic function
     * @param outPath the output path that will only be filled if a path is
     * found, otherwise it won't get touched.
    ...
    /**
     * Performs a non-interruptible search, trying to find a path made up of
     * nodes from the start node to the goal node attempting to honor costs
    ...
    /**
     * Performs an interruptible search, trying to find a path made up of nodes
     * from the start node to the goal node attempting to honor costs provided
     * by the graph.
     *
     * @param request the pathfinding request
     * @param timeToRun the time in nanoseconds that can be used to advance the
     * search
