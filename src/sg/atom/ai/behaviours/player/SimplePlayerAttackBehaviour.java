package sg.atom.ai.behaviours.player;

import sg.atom.ai.agents.Agent;
import sg.atom.ai.behaviours.Behaviour;
import sg.atom.ai.behaviours.npc.SimpleAttackBehaviour;
...
public class SimplePlayerAttackBehaviour extends Behaviour implements ActionListener {
    ...
    public void onAction(String name, boolean isPressed, float tpf) {
        ...
        if (isPressed) {
            ...
            Vector2f click2d = AgentsAppState.getInstance().getApp().getInputManager().getCursorPosition();
