...
public class SimpleLookBehaviour extends Behaviour {
     ...
     */
    protected void triggerListeners(PhysicalSpatialControl gameObjectSeen) {
    ...
    protected void controlUpdate(float tpf) {
        List<PhysicalSpatialControl> agents = look(agent, viewAngle);
     ...
     */
    protected List<PhysicalSpatialControl> look(Agent agent, float viewAngle) {
        return AgentsAppState.getInstance().look(agent, viewAngle);
    }
