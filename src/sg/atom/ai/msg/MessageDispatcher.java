 ...
 * ****************************************************************************
 */
package sg.atom.ai.msg;

import com.jme3.util.IntMap;
import sg.atom.core.datastructure.collection.Array;
import sg.atom.core.datastructure.collection.Pool;
import sg.atom.core.utils.reflect.ClassReflection;
...
public class MessageDispatcher {
    ...
    /**
     * Registers a listener for a selection of message types. Messages without
     * an explicit receiver are broadcasted to all its registered listeners.
     *
     * @param listener the listener to add
    ...
    /**
     * Removes all the telegrams from the queue and releases them to the
     * internal pool.
     */
    ...
    /**
     * Removes all the telegrams from the queue and the registered listeners for
     * all the messages.
     */
    public void clear() {
        clearQueue();
    ...
    /**
     * Sends an immediate message to all registered listeners, with no extra
     * info.
     * <p>
     ...
     * The receiver doesn't need to be a register listener for the specified
     * message code.
     * <p>
     * This is a shortcut method for {@link #dispatchMessage(float, Telegraph, Telegraph, int, Object) dispatchMessage(0, sender,
     * receiver, msg, null)}
     *
     * @param sender the sender of the telegram
     * @param receiver the receiver of the telegram; if it's {@code null} the
     * telegram is broadcasted to all the receivers registered for the specified
     * message code
     * @param msg the message code
     */
    ...
    /**
     * Sends a message to all registered listeners, with the specified delay but
     * no extra info.
     * <p>
    ...
    /**
     * Sends a message to the specified receiver, with the specified delay but
     * no extra info. The receiver doesn't need to be a register listener for
     ...
     * routes the message to the correct agents (if no delay) or stores in the
     ...
     *
     * @param deltaTime the time span between the current frame and the last
     * frame in seconds
     */
     ...
     *
     * @param callback The callback used to report pending messages
     * individually. *
     */
     ...
     * for immediate telegrams and {@link #update(float) update} for delayed
     * telegrams. It first calls the message handling method of the receiving
     * agents with the specified telegram then returns the telegram to the pool.
     *
     ...
     * method of the {@link MessageDispatcher} to report its pending messages
     * individually.
     *
     * @author davebaol
     */
    public interface PendingMessageCallback {
         ...
         * @param extraInfo Any additional information that may accompany the
         * message
         */
